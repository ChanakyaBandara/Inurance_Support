            ...
            if (dataSnapshot.exists()){
                ...
                for(DataSnapshot keyNode : dataSnapshot.getChildren()) {
                    ...
                    if(keyNode.child("states").getValue(String.class).equals("Completed")){
                        ...
                        accident.setDes(keyNode.child("des").getValue(String.class));
                ...
                if(ACClist.isEmpty()){
                    Toast.makeText(claim_history.this, "No Records", Toast.LENGTH_LONG).show();
                }else {
                    new Recycleview_accident_config().setConfig(recyclerView,claim_history.this,ACClist,Keys);
                }
            }else{
                Toast.makeText(claim_history.this, "No Records", Toast.LENGTH_LONG).show();
            }
